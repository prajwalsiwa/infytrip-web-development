...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center space-x-1 rounded-lg text-gray-dark",
      className
    )}
    {...props}
  />
